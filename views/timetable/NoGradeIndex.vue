                ...
                <div class="d-f f-j-b f-a-c mt-20 fc-7">
                    ...
                    <div>
                        ...
                        <el-popover placement="bottom" width="260" trigger="click" ref="calendarPopover" popper-class="calendar-popover">
                            ...
                            <span v-if="tableType == 'day'" slot="reference" class="out-line">{{$$tools.format(calendarTtime)}}</span>
                            ...
                            <el-table-column align="center" :render-header="tableHeader" min-width="185" :resizable="false">
                                <template slot-scope="scope">
                                    <div class="cursor-pointer item-box" mytype="week_one">
                                        ...
                                        <div class="add-course d-f f-a-c f-j-c" v-if="!scope.row.week_one.past_due && $$tools.isAuthority('noClassScheduling')"
                            ...
                            <el-table-column align="center" :render-header="tableHeader" min-width="185" :resizable="false">
                                <template slot-scope="scope">
                                    <div class="cursor-pointer item-box" mytype="week_two">
                                        ...
                                        <div class="add-course d-f f-a-c f-j-c" v-if="!scope.row.week_two.past_due && $$tools.isAuthority('noClassScheduling')"
                            ...
                            <el-table-column align="center" :render-header="tableHeader" min-width="185" :resizable="false">
                                <template slot-scope="scope">
                                    <div class="cursor-pointer item-box" mytype="week_three">
                                        ...
                                        <div class="add-course d-f f-a-c f-j-c" v-if="!scope.row.week_three.past_due && $$tools.isAuthority('noClassScheduling')"
                            ...
                            <el-table-column align="center" :render-header="tableHeader" min-width="185" :resizable="false">
                                <template slot-scope="scope">
                                    <div class="cursor-pointer item-box" mytype="week_four">
                                        ...
                                        <div class="add-course d-f f-a-c f-j-c" v-if="!scope.row.week_four.past_due && $$tools.isAuthority('noClassScheduling')"
                            ...
                            <el-table-column align="center" :render-header="tableHeader" min-width="185" :resizable="false">
                                <template slot-scope="scope">
                                    <div class="cursor-pointer item-box" mytype="week_five">
                                        ...
                                        <div class="add-course d-f f-a-c f-j-c" v-if="!scope.row.week_five.past_due && $$tools.isAuthority('noClassScheduling')"
                            ...
                            <el-table-column align="center" :render-header="tableHeader" min-width="185" :resizable="false">
                                <template slot-scope="scope">
                                    <div class="cursor-pointer item-box" mytype="week_six">
                                        ...
                                        <div class="add-course d-f f-a-c f-j-c" v-if="!scope.row.week_six.past_due && $$tools.isAuthority('noClassScheduling')"
                            ...
                            <el-table-column align="center" :render-header="tableHeader" min-width="185" :resizable="false">
                                <template slot-scope="scope">
                                    <div class="cursor-pointer item-box" mytype="week_seven">
                                        ...
                                        <div class="add-course d-f f-a-c f-j-c" v-if="!scope.row.week_seven.past_due && $$tools.isAuthority('noClassScheduling')"
...
export default {
  data () {
    return {
      ...
      calendarTtime: new Date().getTime() / 1000, //日历默认时间
      timeTableInfo: {}, //课表总数据
  ...
  methods: {
    setNewDate () {
      let now = new Date(this.calendarTtime * 1000);
    ...
    lastWeekLists () {
      if (this.tableType === 'week') {
        ...
        this.calendarTtime = last / 1000;
        this.getWeekList(last, 'all');
      } else {
        this.calendarTtime = this.calendarTtime - ONE_DAY_LONG / 1000;
        this.setNewDate();
        this.getWeekList(this.calendarTtime, 'all');
      }
    ...
    tableTypeChange (type) {
      ...
      this.calendarTtime = new Date().getTime() / 1000;
    ...
    detailEdit (detail) {
      ...
      // this.getWeekList(this.calendarTtime * 1000, 'timetable');
    ...
    addTimetable (type, time, full_day, week) {
      ...
      if (type === 'single') {
        ...
        if (this.isSameWeek(this.calendarTtime * 1000)) {
    ...
    studentCheckChange (val) {
      ...
      this.studentCheckAll = checkedCount === this.allStudentLists.filter(m => {return m.scheduled}).length;
    },
    ...
    addStudentClick () {
      ...
      if (this.courseType === 1) {
        this.studentLists = this.checkStudentForm;
        this.studentCheckAll = this.studentLists.length === this.allStudentLists.filter(m => {return m.scheduled}).length;
      } else {
        this.studentRadio = this.radioStudentForm;
      }
    },
    ...
    async getAllTableLists () {
      this.loading = true;
      let result = await this.$$request.post('/timetable/notModelList', {select_time: Math.round(this.calendarTtime), type: this.tableType});
    ...
    async getGradeTableLists () {
      ...
      let result = await this.$$request.post('/timetable/noGradeCourseLists', {
        select_time: Math.round(this.calendarTtime),
        type: this.tableType,
    ...
    resultDispose (resultData) {
      if (this.tableType == 'week') {
        ...
        let newResult = this.hourData.map(v => {
          ...
          let full_date = this.$$tools.format(this.calendarTtime).replace(/\-/g, '/');
  ...
  mounted () {
    this.CalendatObj = Jquery('#myCalendar').calendar({
      ...
      onSelected: (view, date, data) => {
        if (date.getTime() / 1000 === this.calendarTtime) {
          return 0;
        }
        this.calendarTtime = date.getTime() / 1000;
