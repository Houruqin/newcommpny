                                ...
                                <template slot-scope="scope">
                                    <div class="cursor-pointer item-box" mytype="week_one">
                                        ...
                                        <div class="add-course d-f f-a-c f-j-c" v-if="!scope.row.week_one.past_due"
                                            ...
                                            <div v-show="$$tools.isAuthority('hasClassScheduling') && scope.row.week_one.operate"><i class="iconfont icon-add"></i></div>
                                        </div>
                                    </div>
                                </template>
                            </el-table-column>
                                ...
                                <template slot-scope="scope">
                                    <div class="cursor-pointer item-box" mytype="week_two">
                                        ...
                                        <div class="add-course d-f f-a-c f-j-c" v-if="!scope.row.week_two.past_due"
                                            ...
                                            <div v-show="$$tools.isAuthority('hasClassScheduling') && scope.row.week_two.operate"><i class="iconfont icon-add"></i></div>
                                        </div>
                                    </div>
                                </template>
                            </el-table-column>
                                ...
                                <template slot-scope="scope">
                                    <div class="cursor-pointer item-box" mytype="week_three">
                                        ...
                                        <div class="add-course d-f f-a-c f-j-c" v-if="!scope.row.week_three.past_due"
                                            ...
                                            <div v-show="$$tools.isAuthority('hasClassScheduling') && scope.row.week_three.operate"><i class="iconfont icon-add"></i></div>
                                        </div>
                                    </div>
                                </template>
                            </el-table-column>
                                ...
                                <template slot-scope="scope">
                                    <div class="cursor-pointer item-box" mytype="week_four">
                                        ...
                                        <div class="add-course d-f f-a-c f-j-c" v-if="!scope.row.week_four.past_due"
                                            ...
                                            <div v-show="$$tools.isAuthority('hasClassScheduling') && scope.row.week_four.operate"><i class="iconfont icon-add"></i></div>
                                        </div>
                                    </div>
                                </template>
                            </el-table-column>
                                ...
                                <template slot-scope="scope">
                                    <div class="cursor-pointer item-box" mytype="week_five">
                                        ...
                                        <div class="add-course d-f f-a-c f-j-c" v-if="!scope.row.week_five.past_due"
                                            ...
                                            <div v-show="$$tools.isAuthority('hasClassScheduling') && scope.row.week_five.operate"><i class="iconfont icon-add"></i></div>
                                        </div>
                                    </div>
                                </template>
                            </el-table-column>
                                ...
                                <template slot-scope="scope">
                                    <div class="cursor-pointer item-box" mytype="week_six">
                                        ...
                                        <div class="add-course d-f f-a-c f-j-c" v-if="!scope.row.week_six.past_due"
                                            ...
                                            <div v-show="$$tools.isAuthority('hasClassScheduling') && scope.row.week_six.operate"><i class="iconfont icon-add"></i></div>
                                        </div>
                                    </div>
                                </template>
                            </el-table-column>
                                ...
                                <template slot-scope="scope">
                                    <div class="cursor-pointer item-box" mytype="week_seven">
                                        ...
                                        <div class="add-course d-f f-a-c f-j-c" v-if="!scope.row.week_seven.past_due"
                                            ...
                                            <div v-show="$$tools.isAuthority('hasClassScheduling') && scope.row.week_seven.operate"><i class="iconfont icon-add"></i></div>
                                        </div>
                                    </div>
                                </template>
                            </el-table-column>
                                    ...
                                    <div class="right fc-7 flex1">
                                        <div v-if="row.course.length" v-for="(item, num) in row.course" :key="num"
                                            ...
                                            <div class="d-f f-a-c pl-15 course-item-box">
                                                <div class="flex1 d-f f-a-c">
                                                    <div class="fs-15 fc-5">{{item.grade_name}}</div>
                                                    <div class="ml-50">
...
export default {
  ...
  methods: {
    ...
    tableHeader (elem, {column, $index}) {
      ...
      return elem('div', {'class': 'header-box'}, [
        elem('div', [
          ...
          elem('p', {
            'class': {'fc-m': weekList[$index - 1].day.isToday, 'mt-3': true, 'fs-13': true}
    ...
    async getAllTableLists () {
      ...
      this.gradeInfoCheckLists.lists = result.lists.grade_info.map(v => {
        return v;
      });
