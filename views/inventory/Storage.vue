        ...
        <el-card shadow="hover">
            ...
            <div v-if="listType == 'record'" key="record">
                <el-table class="mt-20 bor-t" :data="storageTable.data" v-loading="loading" stripe>
                    ...
                    <el-table-column label="操作" align="center" v-if="$$tools.isAuthority('cancelTreasuryRecord')">
                        <template slot-scope="scope">
                            <span class="fc-m cursor-pointer" v-if="scope.row.type == 2" @click="cancellationClick(scope.row.id)">作废</span>
                        </template>
                    </el-table-column>
                </el-table>
